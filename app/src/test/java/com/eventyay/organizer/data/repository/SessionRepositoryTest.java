...
public class SessionRepositoryTest {
    ...
    @Before
    public void setUp() {
        when(repository.observableOf(Session.class))
    ...
    public void shouldReturnConnectionErrorOnGetSessionsWithNoneSaved() {
        when(repository.isConnected()).thenReturn(false);
        when(repository.getItems(eq(Session.class), any(SQLOperator.class)))
    ...
    public void shouldSaveSessionsOnGet() {
        ...
        when(repository.syncSave(eq(Session.class), eq(sessions), any(), any()))

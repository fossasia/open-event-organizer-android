...
public class LoginViewModelTest {
    ...
    @Mock Observer<Void> actionLogin;
    @Mock Observer<String> error;
    @Mock Observer<Set<String>> email;
    ...
    public void setUp() {
        loginViewModel =
                new LoginViewModel(
                        authModel, interceptor, sharedPreferenceModel, encryptionService);
    ...
    public void shouldLoginSuccessfully() {
        Mockito.when(authModel.login(LOGIN)).thenReturn(Completable.complete());
    ...
    public void shouldShowLoginError() {
        ...
        Mockito.when(authModel.login(LOGIN)).thenReturn(Completable.error(Logger.TEST_ERROR));

...
public class TracksPresenterTest {
    ...
    @Mock private TracksView tracksView;
    @Mock private TrackRepository trackRepository;
    @Mock private DatabaseChangeListener<Track> databaseChangeListener;
    ...
    public void shouldLoadTracksAutomatically() {
        when(trackRepository.getTracks(anyLong(), anyBoolean()))
                .thenReturn(Observable.fromIterable(TRACKS));
    ...
    public void shouldShowEmptyViewOnNoTracks() {
        ...
        verify(tracksView).showEmptyView(true);
    }

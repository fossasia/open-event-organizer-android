...
public class ChangePasswordViewModelTest {
    ...
    private static final ChangePassword CHANGE_PASSWORD =
            new ChangePassword(OLD_PASSWORD, NEW_PASSWORD, CONFIRM_NEW_PASSWORD);
    ...
    public void setUp() {
        changePasswordViewModel =
                new ChangePasswordViewModel(authModel, interceptor, sharedPreferenceModel);
    }

    @Test
    public void shouldChangePasswordSuccessfully() {
        Mockito.when(authModel.changePassword(CHANGE_PASSWORD)).thenReturn(Completable.complete());
    ...
    public void shouldShowErrorOnDifferentNewAndConfirmPassword() {
        ...
        changePasswordViewModel.changePasswordRequest(
                OLD_PASSWORD, NEW_PASSWORD, CONFIRM_NEW_WRONG_PASSWORD);
    ...
    public void shouldShowErrorOnWrongOldPassword() {
        ...
        Mockito.when(
                        authModel.changePassword(
                                new ChangePassword(any(), NEW_PASSWORD, CONFIRM_NEW_PASSWORD)))
                .thenReturn(Completable.error(Logger.TEST_ERROR));
        ...
        changePasswordViewModel.changePasswordRequest(
                OLD_WRONG_PASSWORD, NEW_PASSWORD, CONFIRM_NEW_PASSWORD);

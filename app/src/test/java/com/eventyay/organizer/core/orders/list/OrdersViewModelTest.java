...
public class OrdersViewModelTest {
    ...
    @Mock Observer<List<Order>> orders;
    ...
    private static final List<Order> ORDERS_LIST =
            Arrays.asList(
    ...
    public void shouldShowOrderError() {
        ...
        when(orderRepository.getOrders(EVENT_ID, false)).thenReturn(TestUtil.ERROR_OBSERVABLE);

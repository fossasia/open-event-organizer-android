    ...
    public View onCreateView(
        ...
        binding =
                DataBindingUtil.inflate(
                        localInflater, R.layout.about_us_fragment, container, false);

        Element legalElement = new Element();
        legalElement.setTitle("Legal");

        legalElement.setOnClickListener(
                v -> {
        ...
        developersElement.setOnClickListener(
                v -> {
                    BrowserUtils.launchUrl(
                            getContext(), getString(R.string.github_developers_link));
                });
        ...
        shareElement.setOnClickListener(
                v -> {
                    ...
                    String shareBody =
                            getString(R.string.msg_check_this_out)
        ...
        thirdPartyLicenses.setOnClickListener(
                v -> {
        ...
        AboutPage aboutPage =
                new AboutPage(getContext())
                        ...
                        .addItem(
                                new Element(
                                        "Version " + BuildConfig.VERSION_NAME, R.drawable.ic_info))

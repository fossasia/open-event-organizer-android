...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferencesFix(@Nullable Bundle bundle, String rootKey) {
        ...
        CheckBoxPreference playSound =
                (CheckBoxPreference) findPreference(Constants.PREF_PLAY_SOUNDS);
        ...
        findPreference(getString(R.string.sales_data_display_key))
                ...
                .setOnPreferenceClickListener(
                        preference -> {
                            ...
                            if (!isDeveloperModeEnabled) {
                                ...
                                builder.setNegativeButton(
                                        R.string.no, (dialog, which) -> builder.show().dismiss());
    ...
    public void toggleDeveloperMode() {
        ...
        manager.getSharedPreferences()
                .edit()
                .putBoolean(getString(R.string.developer_mode_key), isDeveloperModeEnabled)
                .apply();
    }

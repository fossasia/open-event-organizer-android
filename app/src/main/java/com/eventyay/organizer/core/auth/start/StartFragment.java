...
public class StartFragment extends BaseFragment implements StartView {
    ...
    public View onCreateView(
        ...
        startFragmentViewModel =
                ViewModelProviders.of(this, viewModelFactory).get(StartViewModel.class);
    ...
    public void onStart() {
        ...
        startFragmentViewModel
                .getEmailRequestModel()
                .observe(this, emailRequest -> binding.setEmailRequest(emailRequest));
        ...
        binding.url.toggleUrl.setOnClickListener(
                view -> {
        ...
        binding.btnStart.setOnClickListener(
                view -> {
                    ...
                    boolean isBaseUrlLayoutVisible =
                            binding.url.baseUrlLayout.getVisibility() == View.VISIBLE;
                    ...
                    startFragmentViewModel.checkIsEmailRegistered(
                            startFragmentViewModel.getEmailRequestModel().getValue());
                });
    ...
    public void toNextAuthFragment(boolean isEmailRegistered) {
        ...
        getFragmentManager()
                .beginTransaction()
                .addSharedElement(
                        binding.emailLayout, ViewCompat.getTransitionName(binding.emailLayout))

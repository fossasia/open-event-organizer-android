 ...
 * implement the Use the {@link EventListFragment#newInstance} factory method to create an instance
 * of this fragment.
 */
...
public class ListPageFragment extends Fragment implements ListPageView, Injectable {
     ...
     * parameters.
     *
     * <p>parameters can be added in future if required so which can be passed in bundle.
     *
        ...
        eventsViewModel
                ...
                .observe(
                        ...
                        (events) -> {
                            ...
                            if (events == null || events.isEmpty()) this.showEmptyView(true);
                            else this.showEmptyView(false);
                        });
    }
    ...
    private void setupRecyclerView() {
        if (!initialized) {
            eventListAdapter =
                    new ListPageAdapter(eventsViewModel.getEvents(position).getValue(), bus, this);
            ...
            StickyRecyclerHeadersDecoration decoration =
                    new StickyRecyclerHeadersDecoration(eventListAdapter);
    ...
    public void closeSalesSummary() {
        DialogFragment fragment =
                ((DialogFragment) getFragmentManager().findFragmentByTag(SUMMARY_FRAGMENT_TAG));

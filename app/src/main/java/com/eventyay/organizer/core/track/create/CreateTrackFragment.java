...
public class CreateTrackFragment extends BaseFragment implements CreateTrackView {
    ...
    public View onCreateView(
        ...
        createTrackViewModel =
                ViewModelProviders.of(this, viewModelFactory).get(CreateTrackViewModel.class);
        ...
        binding.submit.setOnClickListener(
                view -> {
                    ...
                    if (validator.validate()) createTrackViewModel.createTrack();
    ...
    private void setColorPicker() {
        if (colorPickerDialog == null)
            colorPickerDialog =
                    new ColorPicker(
                            getActivity(),
                            createTrackViewModel.getRed(),
                            createTrackViewModel.getGreen(),
                            createTrackViewModel.getBlue());

...
public class SessionsFragment extends BaseFragment<SessionsPresenter> implements SessionsView {
    ...
    @Inject Lazy<SessionsPresenter> sessionsPresenter;
    ...
    public void openCreateSessionFragment() {
        getFragmentManager()
                ...
                .replace(
                        ...
                        CreateSessionFragment.newInstance(trackId, eventId))
                .addToBackStack(null)
                .commit();
    }
    ...
    public void openUpdateSessionFragment(long sessionId) {
        getFragmentManager()
                ...
                .replace(
                        R.id.fragment_container,
                        CreateSessionFragment.newInstance(trackId, eventId, sessionId))
                .addToBackStack(null)
                .commit();
    }

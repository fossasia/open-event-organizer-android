...
public class ScanQRViewModel extends ViewModel {
    ...
    private final SingleEventLiveData<Boolean> showBarcodePanelLiveData =
            new SingleEventLiveData<>();
    private final SingleEventLiveData<Attendee> onScannedAttendeeLiveData =
            new SingleEventLiveData<>();
    ...
    public void processBarcode(String barcode) {
        ...
        Observable.fromIterable(attendees)
                ...
                .filter(
                        attendee ->
                                (attendee.getOrder().getIdentifier() + "-" + attendee.getId())
                                        .equals(barcode))
                .compose(schedule())
                .toList()
                .subscribe(
    ...
    private void checkAttendee(Attendee attendee) {
        ...
        boolean needsToggle =
                !(toCheckIn && attendee.isCheckedIn || toCheckOut && !attendee.isCheckedIn);

...
public final class ViewTransformers {
    ...
    public static CompletableTransformer disposeCompletable(
    ...
    public static <T, V extends Erroneous> ObservableTransformer<T, T> erroneous(V view) {
        return observable ->
                observable.doOnError(
                        throwable -> view.showError(ErrorUtils.getMessage(throwable).toString()));
    }
    ...
    private static <T, V extends Refreshable> ObservableTransformer<T, T> refreshable(
            V view, boolean forceReload) {
        return observable ->
                observable
                        .doOnComplete(
                                () -> {
    ...
    public static <T, V extends ItemResult<T> & Erroneous>
            ObservableTransformer<T, T> erroneousResult(V view) {
        return observable -> observable.compose(result(view)).compose(erroneous(view));
    }

    public static <T, V extends Progressive & Erroneous>
            ObservableTransformer<T, T> progressiveErroneous(V view) {
        return observable -> observable.compose(progressive(view)).compose(erroneous(view));
    }

    public static <V extends Progressive & Erroneous>
            CompletableTransformer progressiveErroneousCompletable(V view) {
        return observable ->
                observable
    ...
    public static <T, V extends Progressive & Erroneous & ItemResult<T>>
            ObservableTransformer<T, T> progressiveErroneousResult(V view) {
        return observable -> observable.compose(progressiveErroneous(view)).compose(result(view));
    }

    public static <T, V extends Progressive & Erroneous & Refreshable>
            ObservableTransformer<T, T> progressiveErroneousRefresh(V view, boolean forceReload) {
        return observable ->
                observable
    ...
    public static <T, V extends Progressive & Erroneous & Refreshable & ItemResult<T>>
            ObservableTransformer<T, T> progressiveErroneousResultRefresh(
                    V view, boolean forceReload) {
        return observable ->
                observable
    ...
    public static <T, V extends Progressive & Refreshable>
            ObservableTransformer<T, T> progressiveRefresh(V view, boolean forceReload) {
        return observable ->
                observable.compose(progressive(view)).compose(refreshable(view, forceReload));
    }

    public static <T, V extends Emptiable<T>> SingleTransformer<List<T>, List<T>> emptiable(
            V view, List<T> items) {
        return observable ->
                observable

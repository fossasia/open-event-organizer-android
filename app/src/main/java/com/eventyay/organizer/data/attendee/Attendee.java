...
@EqualsAndHashCode(
        callSuper = false,
        exclude = {"attendeeDelegate", "checking"})
@Table(database = OrgaDatabase.class)
@SuppressWarnings({"PMD.ExcessivePublicCount", "PMD.TooManyFields"})
public class Attendee extends AbstractItem<AttendeeViewHolder>
        implements Comparable<Attendee>, HeaderProvider, IItem<AttendeeViewHolder> {
    ...
    @Column public boolean isCheckedIn;
    @Column public String state;
    @Column public String address;
    @Column public String pdfUrl;
    ...
    @Column public String blog;
    @Column public String homeAddress;
    @Column public String workAddress;
    @Column public String jobTitle;
    @Column public String taxBusinessInfo;
    @Column public String phone;
    @Column public String gender;
    @Column public String company;
    @Column public String workPhone;
    @Column public String birthDate;
    @Column public String twitter;
    @Column public String facebook;
    @Column public String github;
    @Column public String website;
    @Column public String shippingAddress;
    @Column public String billingAddress;

    // Migration 8 additions

    @Column public String checkinTimes;

    // Migration 16 additions

    @Column public String checkoutTimes;

    // Non model entities

    @JsonIgnore @Column public boolean checking;

...
public final class ViewUtils {
    ...
    public static void setRecyclerViewScrollAwareFabBehaviour(
            RecyclerView recyclerView, FloatingActionButton fab) {
    ...
    public static void setTitle(AppCompatActivity activity, String title) {
        ...
        if (actionBar == null) Timber.e("No ActionBar found in Activity %s", activity);
    ...
    public static void showDialog(
        ...
        if (activity instanceof AppCompatActivity) {
            AlertDialog alertDialog =
                    new AlertDialog.Builder(new ContextThemeWrapper(activity, R.style.AlertDialog))
                            .setTitle(title)
                            .setMessage(message)

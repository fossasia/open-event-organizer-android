...
public abstract class AbstractDateTimePicker extends androidx.appcompat.widget.AppCompatButton {
    ...
    protected void bindTemporal(
            String date, String format, Function<ZonedDateTime, AlertDialog> dialogProvider) {
        if (date == null) return;
        ...
        this.setOnClickListener(
                view ->
                        dialogProvider
                                .apply(DateUtils.getDate(DateUtils.formatDateToIso(current)))
                                .show());
    }
